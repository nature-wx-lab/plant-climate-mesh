...
- 地図: Webメルカトル図法、Natural Earth 1:50m境界。クリックした気象格子中心の国・地域名と、Natural Earthの主要都市・行政中心点から求めた周辺目安を表示
...
比較基準は1地点だけです。「基準に」で現在地点と取得済みデータをブラウザのメモリ内に保持し、次の地点を選ぶと比較先を実線・塗りつぶし、基準を破線・輪郭で重ねます。基準地点はページ再読み込みで消去され、端末の永続ストレージには保存しません。
