...
def main() -> None:
    ...
    require("<script src=\"./app.js?v=20260926-overview\" defer></script>" in index, "versioned local deferred script missing")
    require('href="./styles.css?v=20260926-overview"' in index, "versioned local stylesheet missing")
