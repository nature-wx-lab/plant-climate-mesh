...
def main() -> None:
    ...
    require("<script src=\"./app.js?v=20260926-explorer\" defer></script>" in index, "versioned local deferred script missing")
    require('href="./styles.css?v=20260926-explorer"' in index, "versioned local stylesheet missing")
